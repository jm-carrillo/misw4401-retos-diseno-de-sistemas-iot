...
#define LED_PR D3 // LED PHOTORESISTOR
#define PR A0 // PHOTORESISTOR
int photoValue;
int luxValue;

#define VIN 3.3 // V voltage salida
#define R 1000 //ohm valor resistencia
...
void loop()
{
  ...
  if ( !isnan(h) && !isnan(t) && !isnan(luxValue) ) {
